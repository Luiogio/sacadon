...
export default function ImpactBag() {
  return (
    <div className="impact-section">
      <div className="impact-titre sacadon-title2">Un sac à impact écologique</div>
      ...
      <div className="sacadon-text2 impact-avantages">
      ...
      <Link to="/information-pedagogie" className="need-more-button impact-button">
