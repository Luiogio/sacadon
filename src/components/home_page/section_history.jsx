    ...
    <div className="history-section">
      ...
      <div className="history-content">
        ...
        <div className="sacadon-text2 history-text">
          Derrière SACADON, il y a une histoire,<br /> celle d’un <b>entrepreneur engagé</b>
          (fondateur du <a href='https://www.handicap-international.fr/fr/actualites/sac-a-sapin' target="_blank">Sac à Sapin</a>),<br /> d’une volonté <br />
          <b>familiale et intergénérationnelle</b> de répondre à deux <br />
          urgences : la <b> pollution plastique</b> et la <b>solidarité</b>.<br />
